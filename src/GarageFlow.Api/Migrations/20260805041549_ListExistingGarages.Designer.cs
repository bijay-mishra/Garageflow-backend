...
namespace GarageFlow.Api.Migrations
{
    ...
    [Migration("20260805041549_ListExistingGarages")]
    partial class ListExistingGarages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GarageFlow.Api.Domain.SupportMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GarageFlow.Api.Domain.SupportThread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("ReadByAgentAt")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("Audience", "LastMessageAt");
            ...
            modelBuilder.Entity("GarageFlow.Api.Domain.SupportMessage", b =>
                {
                    b.HasOne("GarageFlow.Api.Domain.SupportThread", "Thread")
                        .WithMany("Messages")
